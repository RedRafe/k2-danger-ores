...
local cp1 = KDO.config["chemical-plant"]
local cp2 = KDO.config["chemical-plant-2"]
local cp3 = KDO.config["kr-advanced-chemical-plant"]
local or1 = KDO.config["oil-refinery"]
local or2 = KDO.config["oil-refinery-2"]
local or3 = KDO.config["oil-refinery-3"]
local ep1 = KDO.config["kr-electrolysis-plant"]
local ep2 = KDO.config["kr-electrolysis-plant-2"]
...
KDO.add_unlock(or3._technology, or3.name)
...
KDO.add_unlock(ep2._technology, ep2.name)
